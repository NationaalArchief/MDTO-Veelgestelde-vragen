...
- [Bekijk de GitHub repository](https://github.com/NationaalArchief/MDTO-Veelgestelde-vragen)
- [Maak een issue aan](https://github.com/NationaalArchief/MDTO-Veelgestelde-vragen/issues/new)
- [Bekijk openstaande issues](https://github.com/NationaalArchief/MDTO-Veelgestelde-vragen/issues)
...
| :------ | :---------------- | :------------------------------------------------------------------------------------------ | :--- | :------------------------------------------- |
| **1.0** | Nationaal Archief | Geaccordeerd op 7 april 2021 ([Stukken en verslag](https://kiacommunity.nl/thoughts/18354)) | —    |<ul><li>[Revisiehistorie](https://github.com/NationaalArchief/MDTO-Veelgestelde-vragen/commits/main)<li>[Wijzigingen 2021–2026](https://nationaalarchief.github.io/MDTO-Veelgestelde-vragen/#welke-wijzigingen-zijn-gedaan-aan-mdto-voor-de-overgang-naar-github)</li></ul> |
...
|                                       |                                                                     |
| :------------------------------------ | :------------------------------------------------------------------ |
| <strong>Deze versie</strong>          | https://nationaalarchief.github.io/MDTO-XSD/                        |
| <strong>Vorige versie</strong>        | N.v.t.<br> Dit is de eerste versie                                  |
| <strong>Meest recente versie</strong> | https://nationaalarchief.github.io/MDTO-XSD/                        |
| <strong>Huidige werkversie</strong>   | N.v.t. <br> Er is op dit moment geen nieuwe versie in voorbereiding |

**Revisiehistorie:**<br>
[Revisiehistorie](https://github.com/NationaalArchief/MDTO-XSD/commits/master)
